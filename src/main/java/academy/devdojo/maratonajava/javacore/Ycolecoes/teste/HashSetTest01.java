...
public class HashSetTest01 {
    public static void main(String[] args) {
        ...
        Set<Manga> mangas = new LinkedHashSet<>();//coleção que permite apenas elementos unicos, e os elementos serão organizados baseado no hash, o set não é indexado, você navega pela coleção, podemos usar foreach
